function aplicarDescuento(precio: number, descuento: number = 5): number {
    let descuentoDecimal: number = descuento / 100;
...
function obtenerDia(year: number = new Date().getFullYear(), month: number): number {
    let day = 0;
    switch (month) {
        case 1:
        case 3:
